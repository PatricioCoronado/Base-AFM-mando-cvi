...
#define  CONFIGURAP_CERRARPCOM            22      /* control type: command, callback function: CerrarPuertoCallback */
#define  CONFIGURAP_APLICA_TR             23      /* control type: command, callback function: aplicar_retardo_timeout */
#define  CONFIGURAP_CLOSECONFIG           24      /* control type: command, callback function: AplicarConfigCallback */
#define  CONFIGURAP_DECORATION_7          25      /* control type: deco, callback function: (none) */
#define  CONFIGURAP_DECORATION_4          26      /* control type: deco, callback function: (none) */
#define  CONFIGURAP_DECORATION_5          27      /* control type: deco, callback function: (none) */
#define  CONFIGURAP_DECORATION_6          28      /* control type: deco, callback function: (none) */
#define  CONFIGURAP_IDENTIFICACION        29      /* control type: string, callback function: (none) */
#define  CONFIGURAP_LEDCONFIG             30      /* control type: LED, callback function: cambiar_de_modo */
...
#define  MENSAJES_COMANDO                 10      /* control type: string, callback function: enviar_comando */
...
#define  MENUSCPI_MENUVERSION             5       /* callback function: version_scpi */
#define  MENUSCPI_MENUCLS                 6       /* callback function: cls_scpi */
#define  MENUSCPI_AUTOR                   7       /* callback function: autor */
...
void CVICALLBACK autor(int menubar, int menuItem, void *callbackData, int panel);
